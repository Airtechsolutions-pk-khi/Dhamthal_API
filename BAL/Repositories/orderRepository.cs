...
namespace BAL.Repositories
{
    public class orderRepository : BaseRepository
    {
        ...
        public orderRepository()
            : base()
        {
            DBContext = new db_a8354d_dhamtalEntities();

        }

        public orderRepository(db_a8354d_dhamtalEntities contextDB)
            : base(contextDB)
        {
            DBContext = contextDB;
        }
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            foreach (var item in getTokens)
                            {
                                ...
                                token.Title = obj.BrandName == "" ? "Dhamtal" : obj.BrandName + " | New Order for Delivery";
