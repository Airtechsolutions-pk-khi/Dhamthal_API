...
namespace WebAPICode.Helpers
{
    public class DBHelper
    {
        ...
        private static readonly string connectionString = "data source=sql5103.site4now.net;initial catalog=db_a8354d_dhamtal;persist security info=True;user id=db_a8354d_dhamtal_admin;password=Tech@123;";
